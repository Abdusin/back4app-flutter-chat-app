...
class AppSpaces {
  ...
  static const horizontal35 = SizedBox(width: 35);

  static const horizontal40 = SizedBox(width: 40);

  static const horizontal45 = SizedBox(width: 45);
  ...
  static const vertical35 = SizedBox(height: 35);

  static const vertical40 = SizedBox(height: 40);

  static const vertical45 = SizedBox(height: 45);
